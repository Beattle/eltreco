...
?>
		<a class="show_more" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=0">Скрыть</a>
<?
	else:
?>
		<a class="show_more" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=1">Показать ещё</a>
<?
	endif;
endif
?>
