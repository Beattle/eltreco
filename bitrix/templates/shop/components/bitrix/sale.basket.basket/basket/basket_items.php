                        ...
                        <tr>
                           ...
                           <td>
                              <div class="selName col-white">
                                 Для того чтобы начать оформление заказа, нажмите кнопку "Продолжить".
                              </div>
                           </td>
                        </tr>
                     </tbody>
	...
	?>
                     ...
                     <tr>
                         ...
                         <td  class="vg-alignc">
                             ...
                             <?/*<input type="submit" class="vg-btn vg-btnGreen vg-submit" value="Оформить заказ" name="BasketOrder" id="basketOrderButton2"/>*/?>
                         </td>
                     </tr>
                 </table>
             </div>
