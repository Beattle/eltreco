		...
		<td valign="top">
			<table class="sale_order_full_table">
				...
				<form method="post" action="<?= $arParams["PATH_TO_ORDER"] ?>" name="order_auth_form">
					...
					<?/*<tr>
						<td nowrap><?echo GetMessage("STOF_PHONE")?> <span class="sof-req">*</span><br />
							<input type="text" name="USER_PHONE" maxlength="30" size="30">&nbsp;&nbsp;&nbsp;</td>
					</tr>*/?>
					<tr>
					...
					<tr>
						<td nowrap>
							<input type="submit" value="<?echo GetMessage("STOF_NEXT_STEP")?>" class="vg-btn vg-btnGreen vg-submit">
