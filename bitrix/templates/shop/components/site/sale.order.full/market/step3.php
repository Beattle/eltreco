...
<div>
	Стоимость доставки уточняйте у менеджера и на сайте. Если доставка платная, то ее стоимость не включена в стоимость заказа и должна быть оплачена отдельно
</div>
