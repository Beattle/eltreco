	...
	<table class="partner">
		...
		<tbody>
							...
							case "N":
								for ($i = 0; $i<$inputNum; $i++)
								{
									...
									if($USER->GetID())
									{
										...
										{
											case "Q01":
												if (!$value) $value = $USER->GetFullName();
												break;
											case "Q06":
												$value = $USER->GetEmail();
								...
								?>
								<input type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="25" value="<?=$value?>"<?=$readonly?> /><?
			...
			<tr>			
				<td>
					<br />
					<strong>Данные для регистрации на сайте</strong>
				</td>
			</tr>
			<tr>
				<td>
					<span class="input-title">Логин</span><span class="starrequired">*</span><br />
					<input type="text" name="login" size="25" value="<?=$_REQUEST["login"]?>" />
				</td>
			</tr>
			<tr>			
				<td>
					<span class="input-title">Пароль</span><span class="starrequired">*</span><br />
					<input type="password" name="password" size="25" value="" />
				</td>
			</tr>
			<tr>	
				<td>
					<span class="input-title">Подтверждение пароля</span><span class="starrequired">*</span><br />
